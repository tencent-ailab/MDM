...
from .models.gcl import EGCL, unsorted_segment_sum
...
class EGCLMask(EGCL):
    ...
    def __init__(self, input_nf, output_nf, hidden_nf, edges_in_d=0, nodes_attr_dim=0, act_fn=nn.ReLU(), recurrent=True,
        ...
        EGCL.__init__(self, input_nf, output_nf, hidden_nf, edges_in_d=edges_in_d, nodes_att_dim=nodes_attr_dim,
    ...
    def __init__(self, in_node_nf, in_edge_nf, hidden_nf, device='cpu', act_fn=nn.SiLU(), n_layers=4, coords_weight=1.0,
        ...
        for i in range(0, n_layers):
            self.add_module("gcl_%d" % i,
                            EGCLMask(self.hidden_nf, self.hidden_nf, self.hidden_nf, edges_in_d=in_edge_nf,
